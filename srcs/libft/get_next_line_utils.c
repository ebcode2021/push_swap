...
/*   Updated: 2022/11/25 19:26:42 by eunson           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

int	gnl_strchr(char *s, char c, int len)
{
	int	idx;
...
void	gnl_strcpy(char *dst, const char *src, size_t dstsize)
{
	size_t	index;
...
{
	gnl_strcpy((*new_node)->content, content, len);
	(*new_node)->fd = fd;
